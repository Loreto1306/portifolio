...
export default function Footer(){
    return(
        <footer className="relative w-full bg-[#0a192f] text-white flex flex-col items-center justify-center py-6">
            ...
            <div className="hidden lg:flex flex-col fixed left-8 bottom-0 items-center gap-10">
                {/* Ícones */}
                <a href="https://github.com/Loreto1306" target="_blank" rel="noreferrer">
                    <BsGithub className="text-white hover:text-[#36cb80] transition-colors w-7 h-7" />
                </a>
                <a href="https://www.linkedin.com/in/artur-loreto" target="_blank" rel="noreferrer">
                    <BsLinkedin className="text-white hover:text-[#36cb80] transition-colors w-6 h-6" />
                </a>
            ...
            <div className="hidden lg:flex flex-col fixed  right-[-60px] bottom-0 items-center gap-4">
                <p className="text-xs  opacity-75 rotate-90 tracking-widest hover:text-[#36cb80] cursor-pointer transition-colors">
                    tucorodriguesloreto@hotmail.com.br
                </p>
                <div className="w-px h-24 mt-28 bg-white opacity-30 mt-2" />
            </div>
